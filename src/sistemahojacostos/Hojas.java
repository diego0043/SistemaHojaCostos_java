...
public class Hojas {
    ...
    public void modificar(String codigo, String unidad, String descripcion) {
        //cn.UID("UPDATE unidades SET unidad='" + unidad + "'");
        cn.UID("UPDATE unidades SET descripcion='" + descripcion + "UPDATE unidades SET unidad='" + unidad + "' WHERE codigoHoja='" + codigo + "'");
    }
    ...
    public ResultSet buscarTodo(){
        return (cn.getValores("SELECT * FROM hojas"));
    }
/////

    public void modificar(int codigoHoja, String descripcion, String codigoUnidad) {
        //cn.UID("UPDATE unidades SET unidad='" + unidad + "'");
        cn.UID("UPDATE hojas SET unidad='" + codigoUnidad + "', descripcion='" + descripcion + "'  WHERE codigoHoja='" + codigoHoja + "'");
    }
