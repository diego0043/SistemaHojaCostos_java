...
public class Unidades {
    ...
    public ResultSet buscar(String codigoUnidad) {
        return (cn.getValores("SELECT * FROM unidades WHERE unidad='" + codigoUnidad + "'"));
    }

     public ResultSet EncontrarCod(String descripcion) {
        return (cn.getValores("SELECT * FROM unidades WHERE descripcion='" + descripcion + "'"));
    }
